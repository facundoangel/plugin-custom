...
<div id="poststuff">
      ...
      <form action="" method="post">
          ...
          <div class="postbox" style="margin-right: 20px!important">
			...
			<div>
				<p><strong style="margin-left: 15px">Enviar mail de prueba:</strong></p>
				<button id="btn-test" type="button" style="margin-left: 15px" class="button button-primary">
					Enviar
				</button>
			</div>
              <p><strong style="margin-left: 15px">Notificarme cuando:</strong></p>
                  ...
                  <tr>
                    <div class="alerts_input_box">
                        <div class="alert_input_content">
                            ...
                            <label for="click5_history_log_critical_error">Errores críticos (salud del sitio)</label>
                        </div>
                        ...
                        <div class="alert_input_content">
                            ...
                            <label for="click5_history_log_technical_issue">Estas expirementando problemas técnicos (Errores de Wordpress)</label>
                        </div>
                        ...
                        <div class="alert_input_content">
                            ...
                            <label for="click5_history_log_404">Error de página 404</label>
                        </div>
                    </div>
                  </tr>
                </tbody>
              ...
              <p><strong style="margin-left: 15px">Formato de E-mails:</strong></p>
              <table class="form-table">
                <tbody>
                  <tr>
                    <div class="alerts_input_box">
                    <div class="alert_input_content">
                            ...
                            <label for="click5_history_log_email_template_plain">Texto plano</label>
                        </div>
                ...
                <div class="alert_email_container">
                    ...
                    <?php
                        ...
                        <?php elseif(!empty($alert_email_data)): ?>
                         ...
                         <?php endif; ?>
                         <p><small><em>Puedes ingresar mas de una dirección de correo separando las mismas con comas.</em></small></p>
                        <?php
                        /*if(empty($alert_email_data)):
                            $userData = wp_get_current_user();
                            $userEmail = "";
              ...
              <input value="Guardar alertas" style="margin-left: 15px" class="button button-primary" type="submit" name="save_alerts"/>
            </div>
          </div>
        </form>
      </div>
