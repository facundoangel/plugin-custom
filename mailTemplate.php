  ...
  <html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" style="width:100%;font-family:arial;padding:0;Margin:0">
   ...
   <body style="width:100%;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0"> 
    <div class="" style="background-color:#f6f8fa;"> 
     <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" style="background-color: #f9f9f9;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top"> 
       ...
       <tr>
         <td>
           <table style="max-width: 700px; width: 100%;  margin: auto; ">
             <tr>
               <td>
                  ...
                  <tr>
                     <td style=" ">
                       <h1 style="/*font-family:'Gellix';*/ font-size: 35px; color: #2f343e; margin: 0;" class="logo-h1">Itecsa</h1>
                       <h2 style="font-weight: 400; color:#5e6f79; font-size: 21px; margin: 0;" class="logo-h2">Alerta sobre errores del sitio <strong style="font-weight: 500;" >{$siteName}</strong></h2>
                    </td>
           ...
           <table style="max-width: 700px; width: 100%; margin: auto; background-color: #ff5400; border-radius: 2px;">
             <tr>
               <td>
                  <table style="max-width: 600px; width: 96%; margin: auto;">
                  <tr>
                     <td style=" ">
                       <h2 style="/*font-family:'Gellix';*/ font-size: 23px; font-weight:600; color: #fff; border-bottom: 1px solid rgba(255,255,255,0.3); padding: 20px 0;">Estimado {$userName},</h2>
                       <p style="font-weight: 400; color:#fff; font-size: 16px; line-height: 1.4; padding-bottom: 20px;">Tu estas reciibendo este mail porque has optado por recibir alertas debido a erroes del sitio {$siteName} (<a style="color:#fff;" href="{$siteURL}">{$siteURL}</a>).</p>
                    </td>
               ...
               <td>
                  ...
                  <tr>
                     <td style="padding-bottom: 20px;">
                       <h2 style="/*font-family:'Gellix';*/ font-size: 23px; font-weight:600;  color: #1f262a; border-bottom: 1px solid #cbd6df; padding: 32px 0; margin: 0;">Aqui estas los ultimos {$eventsCount} eventos del registro historico</h2>
END;
                        foreach($dbRequest as $content){
                          ...
                          <h3 style="font-size: 17px; font-weight: 600; color: #ff8f4e; margin: 5px 0;">{$content->plugin}</h3>
           ...
           <table style="max-width: 700px; width: 100%;  margin: auto; background-color: #fff; margin-top: 10px; border-radius: 2px;">
             <tr>
               <td>
                  ...
                  <tr>
                     <td style="padding-bottom: 20px;">
                       <h2 style="/*font-family:'Gellix';*/ font-size: 23px; font-weight:600;  color: #1f262a; border-bottom: 1px solid #cbd6df; padding: 32px 0; margin: 0;">Archivos modificados recientemente del tema</h2>
...
END;
            ...
            <table style="max-width: 700px; width: 100%;  margin: auto; background-color: #fff; margin-top: 10px; border-radius: 2px;">
             <tr>
               <td>
                  ...
                  <tr>
                     <td style="padding-bottom: 20px;">
                       <h2 style="/*font-family:'Gellix';*/ font-size: 23px; font-weight:600;  color: #1f262a; border-bottom: 1px solid #cbd6df; padding: 32px 0; margin: 0;">Cuando busque ayuda con este problema, es posible que le soliciten alguna de la siguiente información: </h2>
                       
                       
                       <table width="100%">
                         <tr>
                           <td style="font-size: 15px; font-weight: 500; padding: 20px 0px; border-bottom: 1px solid #ededed; width: 35%;">Version de Wordpress </td>
                          ...
                          <tr>
                           <td style="font-size: 15px; font-weight: 500; padding: 20px 0; border-bottom: 1px solid #ededed; width: 35%;">Tema activo </td>
                          ...
                          <tr>
                           <td style="font-size: 15px; font-weight: 500; padding: 20px 0;  width: 35%;">version de PHP </td>
           ...
           <table style="max-width: 700px; width: 100%;  margin: auto; background-color: #FF5400; border-radius: 2px; margin-top: 10px; margin-bottom: 30px;">
             <tr>
               <td>
                  <table style="max-width: 600px; width: 96%; margin: auto;">
                  <tr>
                     <td style=" ">
                       <h2 style="/*font-family:'Gellix';*/ font-size: 20px; font-weight:400; color: #fff; padding: 20px 0 0; text-align: center; ">Gracias por elegir a <br/> 
  <strong style="font-weight: 600;">Itecsa</strong></h2>
                      </h3>
                       <!--<h3 style="/*font-family:'Gellix';*/ font-size: 17px; font-weight:400; color: #fff; padding: 10px 0 20px; text-align: center; $paddingBottom"><a style="color:#fff; text-decoration: underline;" target="_blank" href="$unsubscribeLink">Desuscribir</a></h3>-->
           ...
           <table style="max-width: 700px; width: 100%; margin: auto auto 50px auto;">
            <tr>
              <td style="color: #ababab; font-size: 12px; line-height: 22px; text-align: center;">
                Desarrollado por <a href="https://itecsa.com/" style="color: #ababab; text-decoration:underline;">Itecsa</a> plugin v$HistoryVersion.
                <br>
                <a href="$unsubscribeLink" style="color: #ababab; text-decoration:underline;">Actualizar preferencias de envio de mails</a>
              </td>
            </tr>
          </table>
         </td>
