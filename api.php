...
add_action( 'rest_api_init', function () {
	...
	register_rest_route( 'click5_history_log/API', '/test', array(
        'methods' => 'POST',
        'callback' => 'click5_history_log_API_send_mail_test',
        'permission_callback' => '__return_true',
        ) 
    );
...
function click5_history_log_API_send_mail_test( WP_REST_Request $request ) { 
