...
session_start();
/**
* Plugin Name: History Log by click5 (modificado)
* Description: Plugin para visualizar y monitorear actividad en un sitio web
* Version: 2.0
* Author: Itecsa
* Author URI: https://itecsa.com/
* Text Domain: history-log-by-click5-modificado
  ...
  $table_name = $wpdb->prefix . "c5_history";
    ...
    foreach($mailList as $mail){
      ...
      if(!empty($mail)){
        ...
        wp_mail($mail,'Alerta sobre problemas con el sitio '.$blogName,$message,array($mailType,'charset=UTF-8'));  
      }   
    }
});
